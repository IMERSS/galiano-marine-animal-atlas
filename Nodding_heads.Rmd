...
library(tidyverse)
nodding.heads <- read.csv("tabular_data/nodding_heads_reported_records_gridded.csv")
nodding.heads.summary <- read.csv("tabular_data/nodding_heads_summary.csv")
...
animal.grid.map <- mx_diversity_map("nodding_heads")
animal.grid.map
```
...
figs <- mx_status_map("nodding_heads")
