...
cnidarians.summary <- read.csv("tabular_data/cnidarian_summary.csv")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
source("scripts/Cnidarians_map_script.R")
animal.grid.map
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
source("scripts/cnidarians_community_science_contributions.R")
reportingStatusMap
reportingStatusFig
```
