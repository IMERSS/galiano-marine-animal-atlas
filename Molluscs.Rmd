...
With about 49,000 extant species, Mollusca are the second largest phylum after Arthropoda. The phylum comprises seven extant classes, five of which are locally represented, including bivalves, cephalopods, gastropods, chitons, and tusk shells. Over 780 marine species have been identified in British Columbia, `r nrow(mollusc.summary)` of which have been reported for Galiano Island over the last century and a half, through the combined efforts of `r length(unique(molluscs$recordedBy))` individuals.
