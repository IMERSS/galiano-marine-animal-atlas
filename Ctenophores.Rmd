...
library(tidyverse)
ctenophores <- read.csv("tabular_data/ctenophores_records_gridded.csv")
ctenophores.summary <- read.csv("tabular_data/ctenophores_summary.csv")
...
animal.grid.map <- mx_diversity_map("ctenophores")
animal.grid.map
```
...
figs <- mx_status_map("ctenophores")
