...
ctenophores.summary <- read.csv("tabular_data/ctenophore_summary.csv")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
source("scripts/Ctenophores_map_script.R")
animal.grid.map
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
source("scripts/Ctenophores_community_science_contributions.R")
reportingStatusMap
reportingStatusFig
```
