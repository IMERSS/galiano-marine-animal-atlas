...
* [Butter Clam](Saxidomus giganteus), known in Hul'qumi'num as [**S-axwa'**](#taxon:Saxidomus giganteus)
- S-axwa' are a highly valuable trade item, with fresh s-axwa' having been traded to the Interior historically. S-axwa' are extremely valuable to communities that are not close to the ocean, in addition, to S-ts'eyhw s-axwa' (dried butter clams) being an important food source during the winter. 

* [Geoduck Clam](Panopea generosa), known in Hul'qumi'num as [**Pun'eq'**](#taxon:Panopea generosa)
- Pun'eq' is harvested the lowest tide cycles, which typically occur in January. In fact, the word for January means harvest of pun'eq'. 

* [Littleneck Clam](Protothaca staminea), known in Hul'qumi'num as [**Skw'lhey**](#taxon:Protothaca staminea)
- Skw'lhey is popularly steamed, with the juice from this process used as a preventative medicine 

* [Giant Pacific Scallop](Patinopecten caurinus), known in Hul'qumi'num as [**Kwuneem'mun'**](#taxon:Patinopecten caurinus)
...
* [Northern Abalone](Haliotis kamtschatkana), known in Hul'qumi'num as [**S-eyo'**](#taxon:Haliotis kamtschatkana)
- S-eyo' is currently threatened as a result of overharvesting and harvesting S-eyo' has been outlawed. Historically, S-eyo' was used for trade in addition to crafting jewelry from different parts of the shell pattern.
...
- Tl'uxw means "hard" in Hul'qumi'num, with Tl'uxwtl'uxw translating as "hard hard". This name is for the Olympia oyster but is also now used for the introduced Pacific oster. Tl'uxwtl'uxw can be consumed, raw, steamed, or roasted and then dried. 
...
- Sqi'mukw featured in many cultural stories and is consumed as a delicacy, often smaller sized rather than larger sized sqi'mukw. Sqi'mukw is traditionally and commonl caught using a gaff. 
...
- Xulum' is a scare delicacy that has been difficult to find since the 1940s and 1950s. An important delicacy that community members have travelled great distances in ordee to bring Xulum' to Elders unable to travel. 

* [Gumboot Chiton](Cryptochiton stelleri), known in Hul'qumi'num as [**'Ukws'**](#taxon:Cryptochiton stelleri)
