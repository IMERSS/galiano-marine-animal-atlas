...
library(tidyverse)
horseshoe.worms <- read.csv("tabular_data/horseshoe_worms_reported_records_gridded.csv")
horseshoe.worms.summary <- read.csv("tabular_data/horseshoe_worms_summary.csv")
...
species is known locally: *Phoronis ijimai*.
...
animal.grid.map <- mx_diversity_map("horseshoe_worms")
animal.grid.map
```

## Community science contributions

Since the Biodiversity Galiano project began in 2016, our community has documented `r nrow(observed)` marine mammal species in the waters around Galiano Island, confirming all known historical records and adding no new species to the list.
...
figs <- mx_status_map("horseshoe_worms")
