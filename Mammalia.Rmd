...
* [Stellar Sea Lion or California Sea Lion](#taxon: Eumetopias jubatus / Zalophus californianus), known in Hul'qumi'num as [**Shes or Ts'axulus**](#taxon:Eumetopias jubatus / Zalophus californianus)
- Shes are typically 3-4 times larger than ts'axulus, with ts'axulus have a darker appearance in colour. Shes is a special food source for certain animals and people. 

* [River Otter](#taxon: Lontra canadensis), known in Hul'qumi'num as [**Sqeetl'**](#taxon:Lontra canadensis)
- Sqeetl' have large appetite, feeding on fish, crayfish, and crab depending on whether they are in salt or fresh water. Sqeetl' have important spiritual value for certain people. 

* [Harbour Seal](#taxon: Phoca vitulina), known in Hul'qumi'num as [**'E s-hw**](#taxon:Phoca vitulina)
- 'E s-hw feed on mainly fish and shellfish, typically frequenting areas that are protected from bed weather and predation, near an easily accessible foraging site. Young 'E s-hw pups are preffered for eatings. The skin of 'E s-hw is used for oil.

* [Mink](#taxon: Mustela vison), known in Hul'qumi'num as [**Chuchi'q'un'**](#taxon: Mustela vison)
- Chuchi'q'un'is featured in several traditional stories and first hand accounts relating to its charcters and abilities. In traditional stories, Chuchi'q'un' is jester. Chuchi'q'un' fur is highly valued to its short, fine, and dense nature. Chuchi'q'un' fish for salmon, so you may encounter a Chuchi'q'un' competing with you for salmon. 

* [Orca (Killer Whale)](#taxon: Orcinus ocra), known in Hul'qumi'num as [**Q'ul-lhanamutsum**](#taxon:Orcinus ocra)
- Q'ul-lhanamutsum is a highly endangered marine mammals, with the souther resident community comprising only 89 individuals. Q'ul-lhanamutsum pods feed on salmon. Q'ul-lhanamutsum can be your friend, helper, enermy or saviour. The land form of Q'ul-lhanamutsum is stqeeye' (wolf).
